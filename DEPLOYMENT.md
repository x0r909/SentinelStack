...
- [ ] `GRAFANA_ADMIN_PASSWORD` — Change if needed (default: Sentinel@2024!Strong)
...
- Login: admin / Sentinel@2024!Strong
...
2. Login: admin / Sentinel@2024!Strong
...
|---------|-----|-------------|
| Grafana | http://192.168.18.104:3000 | admin / Sentinel@2024!Strong |
